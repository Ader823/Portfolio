	...
	// Bonding box collision, but a is already a rectangle
	function rectsIntersect2(a,b){
		// var ab = a.getBounds();
		var bb = b.getBounds();
		return a.x + a.width > bb.x && a.x < bb.x + bb.width && a.y + a.height > bb.y && a.y < bb.y + bb.height;
	}

	// Checks if there is an object, b, directly below a
	function groundCheck(a,b){
		var ab = a.getBounds();
		var bb = b.getBounds();
		return ab.y + ab.height + 1 >= bb.y && ab.x + ab.width > bb.x && ab.x < bb.x + bb.width;
	}
// Checks if there is an object, b, anywhere below a
	function groundBelow(a,b){
		var ab = a.getBounds();
		var bb = b.getBounds();
